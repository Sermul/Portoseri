    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/Sermul"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/serilbs_91?igsh=MTR4cTZ5Z254dnd3dg=="><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.linkedin.com/in/seri-muliani-lubis-878868371?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><i className="ri-linkedin-fill ri-2x"></i></a>
        </div>
